...
// All lowercase array of name options
var namesList = ["cruise", "winfrey", "tosh", "knowles", "clinton", "obama", 
"redford", "presley", "brady", "jordan", "bolt", "costello"];
// randomnly chosen word set up. 
var chosenName = "";
// Breaks the word into individual letters to be stored in array.
var lettersInChosenName = [];
// Number of blanks we show based on the solution
var numBlanks = 0;
// Mix of blank and solved letters.
...
function roundComplete() {
	...
	if (lettersInChosenName.toString() === blanksAndSuccesses.toString()) {
